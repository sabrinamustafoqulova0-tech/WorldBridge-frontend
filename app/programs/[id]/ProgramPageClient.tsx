...
export default function ProgramPageClient({
  ...
  programId: string;
  initialProgram: ProgramDetail | null;
}) {
  ...
  const [program, setProgram] = useState<ProgramDetail | null>(initialProgram);
  ...
  useEffect(() => {
    ...
    fetchProgram();
  }, [programId, authLoading, isAuthenticated, router, lang, initialProgram]);
